...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\clambird on
     Windows, /home/user/dev/clambird on Linux) in a file named
     clambird@clamwin.com and copy that file to
